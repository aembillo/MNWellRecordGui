...
class MainWindow(wx.Frame):
    def __init__(self,parent):
        ...
        self.pagelist_win = wx.TextCtrl(self, 1, style=wx.TE_MULTILINE)
        self.pagelist_win.Bind(wx.EVT_ENTER_WINDOW, self.Enter_pagelist_window)
...
#         self.target_dir_win.Bind(wx.EVT_ENTER_WINDOW, self.Enter_target_dir_window)
        ...
        self.pagelist_win.SetFont(font)
#         self.target_dir_win.SetFont(font)
        ...
        self.btn_sizer1 = wx.BoxSizer(wx.VERTICAL)
        btnlist1 = (
        ...
        for label,method in btnlist1:
            ...
            self.btn_sizer1.Add(btn,1,wx.EXPAND)
        ...
        self.btn_sizer1.Add(self.build_button,1,wx.EXPAND)
        ...
        self.btn_sizer1.Add(self.publish_button,1,wx.EXPAND)
        ...
        self.btn_sizer1.Add(self.cancel_button,1,wx.EXPAND)
...
#             self.btn_sizer1.Add(btn,1,wx.EXPAND)
        ...
        self.io_sizer.Add(  self.pagelist_win,1,wx.EXPAND)
#         self.io_sizer.Add(  self.target_dir_win,1,wx.EXPAND)
        self.io_sizer.Add(  self.output_win,2,wx.EXPAND)

        self.main_sizer= wx.BoxSizer(wx.HORIZONTAL)
        self.main_sizer.Add(self.io_sizer ,1,wx.EXPAND)
        self.main_sizer.Add(self.btn_sizer1,0,wx.EXPAND)
        ...
        self.pagelist_win.SetValue("<Enter custom page range here>")
#         self.target_dir_win.SetValue("<Enter custom target directory here>")
        self.output_win.SetValue(self.help_text )
        self.output_status_text = 'OUTPUT. Results copied here'
...
#         msg = None
#         for v in self.pagelist_win.GetValue().split():
...
#             self.publish_button.Show()
    ...
    def Enter_pagelist_window(self,event):
        self.status_bar.SetStatusText('Enter page numbers to split out')
        event.Skip()
...
#         in_txt = self.pagelist_win.GetValue()
#         for d in ' ,':
#             if d in in_txt:
